...
<div class="form-group tdk-permohonan">
	...
	<div class="col-sm-4">
		<input id="nomor" type="hidden" class="form-control input-sm digits required" type="text" placeholder="Nomor Surat" name="nomor" value="<?= $surat_terakhir['no_surat_berikutnya']; ?>">
