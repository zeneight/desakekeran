...
<div class="stat-inner">
	...
	<div class="flexcenter mb-15">
		<a class="b-btn bgcolor-1 flexcenter <?= ($tipe==0) ? 'bgcolor2' : 'bgcolor2' ?> btn-xs" onclick="switchType();" style="cursor:pointer;margin:0 3px;"><p>Pie Chart</p></a>
		<a class="b-btn bgcolor-3 flexcenter <?= ($tipe==1) ? 'bgcolor1' : 'bgcolor1' ?> btn-xs" onclick="switchType();" style="cursor:pointer;margin:0 3px;"><p>Bar Chart</p></a>
	</div>
	</div>
		...
		<div class="table-responsive">
				<table class="table table-striped">
					<thead>
						...
						<tr>
							<th style='text-align:left'>n</th><th style='text-align:right'>%</th>
							<?php if ($jenis_laporan == 'penduduk'):?>
			...
			<div class="width-default mt-30">
				...
				<div class="headborder bordergrey1 flexcenter" style="margin:30px 0 15px;"><h2 class="bordercolor-1">Daftar <?= $heading ?></h2></div>
				<div class="table-responsive">
