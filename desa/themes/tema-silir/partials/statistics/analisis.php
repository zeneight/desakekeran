...
<h1 class="text-heading text-lg lg:text-2xl border-b border-dotted border-primary dark:border-white pb-2 title"><?= IS_PREMIUM ? $indikator['pertanyaan'] : $indikator; ?></h1>
