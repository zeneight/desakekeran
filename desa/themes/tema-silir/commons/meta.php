...
<?php defined('THEME_VERSION') or define('THEME_VERSION', 'v3.7.3') ?>
<?php defined('THEME_TIMESTAMP') or define('THEME_TIMESTAMP', '20230227') ?>
...
<meta name='keywords' content="<?= $desa_title ?> <?php !strpos($desa_title, NAMA_DESA) and print(NAMA_DESA) ?> <?= ucwords($this->setting->sebutan_kecamatan) ?> <?= ucwords($desa['nama_kecamatan']) ?>, <?= ucwords($this->setting->sebutan_kabupaten) ?> <?= ucwords($desa['nama_kabupaten']) ?>, Provinsi  <?= ucwords($desa['nama_propinsi']) ?>" />
