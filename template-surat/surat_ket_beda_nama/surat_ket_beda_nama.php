					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action ?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="col-md-12">
								...
								<div class="form-group">
								    <label for="tahun_lahir"  class="col-sm-3 control-label">Tahun Lahir</label>
								    <div class="col-sm-2">
								    	<textarea name="tahun_lahir" class="form-control input-sm required" placeholder="Silahkan input tahun lahir"></textarea>
								    </div>
    							</div>
								<!--
								<div class="form-group">
									<label for="ttl" class="col-sm-3 control-label">Tahun Lahir</label>
									<div class="col-sm-4">
										<input id="tempatlahir" class="form-control input-sm required <?= jecho($cek_anjungan['keyboard'] == 1, TRUE, 'kbvtext'); ?>" type="text" placeholder="Tahun Lahir" name="tempatlahir">
									</div>
