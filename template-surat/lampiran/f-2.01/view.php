...
<page orientation="portrait" format="210x330" style="font-size: 7pt">
    ...
    <p><b>Jenis Pelaporan Pencatatan Sipil (centang)</b></p>
    ...
    <table class="disdukcapil" style="margin-top: 5px;">
        <col span="48" style="width: 2.0833%;">
        <tr>
            <td colspan="48"><strong>DATA KELAHIRAN</strong></td>
        </tr>
        <tr>
            <td>1.</td>
            <td colspan="20">Nama</td>
            <td class="kanan">:</td>
            <td colspan="20"><?= ($input['nama_bayi']); ?></td>
        </tr>
        <tr>
            <td>2.</td>
    ...
    <table class="disdukcapil" style="margin-top: -5px; border: 0px;">
        ...
        <tr>
            <td colspan="2">&nbsp;</td>
            <td colspan="10" class="kiri">No. Reg :</td>
            <td colspan="24">&nbsp;</td>
        ...
        <tr>
            <td colspan="2">&nbsp;</td>
            <td colspan="10" class="tengah">Perbekel Desa Kekeran</td>
            <td colspan="24">&nbsp;</td>
        ...
        <tr>
            <td colspan="2">&nbsp;</td>
            <td colspan="10" class="tengah"><strong>(I Nyoman Suarda)</strong></td>
